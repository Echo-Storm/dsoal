...
class Buffer final : IDirectSoundBuffer8 {
    ...
    std::vector<std::unique_ptr<BufferFXDistortion>> mFXDistortions;
    std::vector<std::unique_ptr<BufferFXEcho>>       mFXEchos;
    std::vector<std::unique_ptr<BufferFXParamEq>>    mFXParamEqs;
...
public:
    ...
    ALCcontext* getContext() const noexcept { return mContext; }
