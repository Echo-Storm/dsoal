 ...
 *
 * The Buffer class owns a std::vector<FXEntry> (mFXList) populated by
 * SetFX. GetObjectInPath returns a pointer to the appropriate wrapper
 * object by matching the requested GUID against mFXList entries.
 */
...
#ifndef DSFXR_LOCATED
#define DSFXR_LOCATED 0
#define DSFXR_FAILED  3
#endif
